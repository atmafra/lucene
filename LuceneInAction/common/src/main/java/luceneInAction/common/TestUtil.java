...
public class TestUtil {
  ...
  public static int hitCount(IndexSearcher searcher, BooleanQuery query) throws IOException {
    return searcher.search(query, 1).totalHits;
  }
  ...
  public static Directory getBookIndexDirectory() throws IOException {
	...
	return new SimpleFSDirectory(new File(System.getProperty("index.dir")).toPath());
  }
